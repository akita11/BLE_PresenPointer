// ======================================================================
// Hibernate_PSoC4_Example01.v generated from TopDesign.cysch
// 04/21/2017 at 12:50
...
module top ;
	...
	wire [0:0] tmpOE__LED_Mode_net;
	wire [0:0] tmpFB_0__LED_Mode_net;
	wire [0:0] tmpIO_0__LED_Mode_net;
	wire [0:0] tmpINTERRUPT_0__LED_Mode_net;
	electrical [0:0] tmpSIOVREF__LED_Mode_net;

	cy_psoc3_pins_v1_10
		#(.id("84e5201e-80b3-4a31-b1f7-61a4636b0c6c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LED_Mode
		 (.oe(tmpOE__LED_Mode_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_Mode_net[0:0]}),
		  .io({tmpIO_0__LED_Mode_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_Mode_net),
		  .interrupt({tmpINTERRUPT_0__LED_Mode_net[0:0]}),
		  .annotation({Net_47}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LED_Mode_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("31d0cf58-d60e-4f6d-bdf5-8dcb418c6b7b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
