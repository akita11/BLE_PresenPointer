...
#if (CY_IP_WCO)
    #define CY_SYS_CLK_WCO_SEL_CRYSTAL                  (1u)    /**< Selects External crystal as WCOfs clock source */
    #define CY_SYS_CLK_WCO_SEL_PIN                      (0u)    /**<Selects External clock input on wco_in pin as WCOfs clock source */
#endif /* (CY_IP_WCO) */
