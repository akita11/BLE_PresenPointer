...
module top ;
	...
	wire [0:0] tmpOE__SWM_net;
	wire [0:0] tmpFB_0__SWM_net;
	wire [0:0] tmpIO_0__SWM_net;
	electrical [0:0] tmpSIOVREF__SWM_net;

	cy_psoc3_pins_v1_10
		#(.id("07e38e61-d76a-438e-85c0-39b013f7e552"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		SWM
		 (.oe(tmpOE__SWM_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SWM_net[0:0]}),
		  .io({tmpIO_0__SWM_net[0:0]}),
		  .siovref(tmpSIOVREF__SWM_net),
		  .interrupt({Net_157}),
		  .annotation({Net_156}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
	...
	assign tmpOE__SWM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("9911a970-1d3b-4709-b2af-8a54fe28387a"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__SWO_net;
	wire [0:0] tmpFB_0__SWO_net;
	wire [0:0] tmpIO_0__SWO_net;
	electrical [0:0] tmpSIOVREF__SWO_net;

	cy_psoc3_pins_v1_10
		#(.id("18cf10b1-3287-443d-8689-719a2bfda8f0"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		SWO
		 (.oe(tmpOE__SWO_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SWO_net[0:0]}),
		  .io({tmpIO_0__SWO_net[0:0]}),
		  .siovref(tmpSIOVREF__SWO_net),
		  .interrupt({Net_161}),
		  .annotation({Net_160}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
	...
	assign tmpOE__SWO_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SWI_net;
	wire [0:0] tmpFB_0__SWI_net;
	wire [0:0] tmpIO_0__SWI_net;
	electrical [0:0] tmpSIOVREF__SWI_net;

	cy_psoc3_pins_v1_10
		#(.id("30bf2aa9-ae4a-450e-b816-aa782bf38bba"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		SWI
		 (.oe(tmpOE__SWI_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SWI_net[0:0]}),
		  .io({tmpIO_0__SWI_net[0:0]}),
	...
	assign tmpOE__SWI_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
