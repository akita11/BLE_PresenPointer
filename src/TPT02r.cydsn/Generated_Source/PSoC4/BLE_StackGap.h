...
/* Accept only advertisement packets from devices where the advertiserís address
...
/* Accept all advertisement packets from devices where the advertiserís address
...
* peer Public and Random (static) Identity Address. The peerís resolvable address being used may 
...
* Identity Address. The localís resolvable address being used may change after the command is called.
*
*  \param peerIdentityAddr: Buffer which contains the information of peer bd address and address type
...
*			Range for N: 0x0001 ÅE0xA1B8 (1 sec ÅEapproximately 11.5 hours)
...
*			             0x02 ÅE0xFF Reserved for Future Use
*
* \return
*  CYBLE_API_RESULT_T : Return value indicates if the function succeeded or
* failed. Following are the possible error codes.
