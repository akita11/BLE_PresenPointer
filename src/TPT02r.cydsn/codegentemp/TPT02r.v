...
module top ;
	...
	wire [0:0] tmpOE__SWID_net;
	wire [0:0] tmpFB_0__SWID_net;
	wire [0:0] tmpIO_0__SWID_net;
	electrical [0:0] tmpSIOVREF__SWID_net;
	...
	cy_psoc3_pins_v1_10
		...
		SWID
		 (.oe(tmpOE__SWID_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SWID_net[0:0]}),
		  .io({tmpIO_0__SWID_net[0:0]}),
		  .siovref(tmpSIOVREF__SWID_net),
		  .interrupt({Net_142}),
		  .annotation({Net_164}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
	...
	assign tmpOE__SWID_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__SWMAIN_net;
	wire [0:0] tmpFB_0__SWMAIN_net;
	wire [0:0] tmpIO_0__SWMAIN_net;
	electrical [0:0] tmpSIOVREF__SWMAIN_net;

	cy_psoc3_pins_v1_10
		#(.id("2c6c6ba7-10e5-4f06-9529-13b2b9c86773"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SWMAIN
		 (.oe(tmpOE__SWMAIN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SWMAIN_net[0:0]}),
		  .io({tmpIO_0__SWMAIN_net[0:0]}),
		  .siovref(tmpSIOVREF__SWMAIN_net),
		  .interrupt({Net_157}),
		  .annotation({Net_156}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
	...
	assign tmpOE__SWMAIN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SWBACK_net;
	wire [0:0] tmpFB_0__SWBACK_net;
	wire [0:0] tmpIO_0__SWBACK_net;
	electrical [0:0] tmpSIOVREF__SWBACK_net;

	cy_psoc3_pins_v1_10
		#(.id("e66071df-dec1-4896-a1d1-1d99a11750d9"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SWBACK
		 (.oe(tmpOE__SWBACK_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SWBACK_net[0:0]}),
		  .io({tmpIO_0__SWBACK_net[0:0]}),
		  .siovref(tmpSIOVREF__SWBACK_net),
		  .interrupt({Net_159}),
		  .annotation({Net_158}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
	...
	assign tmpOE__SWBACK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SWBLACKOUT_net;
	wire [0:0] tmpFB_0__SWBLACKOUT_net;
	wire [0:0] tmpIO_0__SWBLACKOUT_net;
	electrical [0:0] tmpSIOVREF__SWBLACKOUT_net;

	cy_psoc3_pins_v1_10
		#(.id("4a3ea77a-6f50-4895-ae94-a35f8d50b89b"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SWBLACKOUT
		 (.oe(tmpOE__SWBLACKOUT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SWBLACKOUT_net[0:0]}),
		  .io({tmpIO_0__SWBLACKOUT_net[0:0]}),
		  .siovref(tmpSIOVREF__SWBLACKOUT_net),
		  .interrupt({Net_161}),
		  .annotation({Net_160}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
	...
	assign tmpOE__SWBLACKOUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
