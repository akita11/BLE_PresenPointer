...
*  The ÅgEnable wakeup from Deep Sleep ModeÅh selection has an influence on this 
...
*  Deep Sleep.
*  The ÅgEnable wakeup from Deep Sleep ModeÅh selection has influence on this 
*  function implementation:
